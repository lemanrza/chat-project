      ...
      <div className="w-full max-w-md rounded-2xl p-8 flex flex-col gap-6 z-10">
        ...
        <div className=" rounded-xl shadow p-6 flex flex-col gap-4">
          ...
          <form className="flex flex-col gap-4">
            <div>
              <label className="text-sm font-medium text-[#222]">{t("email_address")}</label>
              <input
                type="email"
            ...
            <button type="submit" className="bg-green-500 text-white rounded-lg py-2 font-semibold hover:bg-blue-400 transition">{t("send_reset_link")}</button>
          </form>
