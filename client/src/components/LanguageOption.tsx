...
const LanguageOption: React.FC<LanguageOptionProps> = ({ code, name }) => (
    <div
        className="w-full flex items-center gap-2 px-4 py-3 rounded-lg bg-white border border-gray-200 shadow-sm text-base font-semibold transition-all duration-200 group hover:bg-gradient-to-r hover:scale-[1.03] hover:shadow-lg"
    >
