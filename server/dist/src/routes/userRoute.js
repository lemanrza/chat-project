...
import { deleteUser, getUserById, getUsers, loginUser, registerUser, unlockAccount, updateCurrentUser, getCurrentUser, uploadProfileImage, deleteProfileImage, upload, changePassword, deleteCurrentUser, verifyUserEmail, addUserConnection, removeUserConnection, getAvailableUsersToConnect, updateUserController, acceptConnection, rejectConnection, forgotPassword, resetPassword, } from "../controllers/userController.js";
...
userRouter.delete("/me/:userId/connections/:connectionId", removeUserConnection);
