...
import { deleteUser, getUserById, getUsers, loginUser, registerUser, unlockAccount, updateCurrentUser, getCurrentUser, uploadProfileImage, deleteProfileImage, upload, changePassword, deleteCurrentUser, verifyUserEmail, addUserConnection, removeUserConnection, getAvailableUsersToConnect, updateUserController, } from "../controllers/userController.js";
...
userRouter.post("/me/:userId/upload-image", authenticateToken, upload.single("avatar"), uploadProfileImage);
...
userRouter.delete("/me/:userId/connections/:connectionId", authenticateToken, removeUserConnection);
